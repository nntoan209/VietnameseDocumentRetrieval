...
class DataArguments:
    ...
    merged_corpus_vi: str = field(
        default=None, metadata={"help": "Path to Vietnamese corpus"}
    )
    merged_queries_vi: str = field(
        default=None, metadata={"help": "Path to Vietnamese queries"}
    )
    merged_corpus_en: str = field(
        default=None, metadata={"help": "Path to English corpus"}
    )
    merged_queries_en: str = field(
        default=None, metadata={"help": "Path to English queries"}
    )
    train_data: str = field(
        default=None, metadata={"help": "One or more paths to training data", "nargs": "+"}
    )
    mix_data: bool = field(
        default=True, metadata={"help": "Whether to mix the training data"}
    )
...
class RetrieverTrainingArguments(TrainingArguments):
    resume_from_checkpoint: bool = field(default=False, metadata={"help": "resume from the latest checkpoint"})
    ...
    aux_loss: bool = field(default=False, metadata={"help": "use auxilary loss for cross-lingual training"})

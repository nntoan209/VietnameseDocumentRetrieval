...
model = KenlmModel.from_pretrained("BGE_M3/process_data/kenlm/wikipedia", "vi")
...
def create_train_data(sample):
    ...
    return {
        ...
        "perplexity": model.get_perplexity(sample[positive_column]),
    }

train_dataset = dedup_dataset.map(create_train_data, remove_columns=["title", "sapo", "body_text"], num_proc=32)

# temporary save the dataset
train_dataset.to_parquet("data/newssapo/baomoi_perplexity.parquet")
